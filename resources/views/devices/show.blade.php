                            ...
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-6 col-md-5">
                                        <i class="mdi mdi-message-text"></i><b> {{ __('Posted on') }}</b> {{ $review->created_at->formatLocalized('%d %B %Y, %R') }} / {{ $review->created_at->timezone('Europe/London')->format('H:i') }} / {{ $review->created_at->format('d M Y h:i a') }}
                                        @if ($index == 0)
